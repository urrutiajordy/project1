...
<td><span id="spryselect2"><select id="n_clinica" name="n_clinica" class="form-control"></select></span>
</td>
</tr>
<tr>
...
<td><input class="form-control" type="text" name="contrato" id="contrato" readonly /></td>
</tr>
<tr>
...
<tr>
<td colspan="4"><select id="monto" name="monto" style="visibility:hidden"></select>
</td>
</tr>
<tr>
<input type="hidden" name="generado_por" value="<?php echo $row_Recordset2['id_usuario']; ?>" />
<td colspan="4"><center><input class="btn btn-primary" type="submit" value="REGISTRAR" name="Registrar" /></center></td>
</tr>
