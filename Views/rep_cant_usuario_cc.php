...
$(function () {
    ...
    var chart = new Highcharts.Chart({
        ...
        title: {
            text: 'CANTIDAD CITAS REGISTRADAS POR USUARIO'
        },
        plotOptions: {
          column: {
                dataLabels: {
...
$sql=$local->query("select count(id_registro) as cantidad
                from registro
                where activo='1' and generado_por='1000007' and fecha_registro between '".$bus2." 00:00:00' and  '".$bus3." 23:59:59'");
while($res=$sql->fetch_array()){            
?>      
                [<?php echo $res['cantidad'] ?>],
    <?php
...
$sql=$local->query("select count(id_registro) as cantidad
                from registro
                where activo='1' and generado_por='1' and fecha_registro between '".$bus2." 00:00:00' and  '".$bus3." 23:59:59'");
while($res=$sql->fetch_array()){            
?>      
                [<?php echo $res['cantidad'] ?>],
    <?php
...
<h2><div align="center"><h3><span class="label label-info">REPORTE POR USUARIO</span></h3></div></h2>
<br>
 <form method="post">
  <table align="center">
  <tr>
...
if(isset($_POST["btn1"])){
    ...
    $sql="select id_registro, fecha_registro, fecha_cita, paciente.nombre_apellido as nom_paciente,tipo_clinica.nombre as nombre_tip_cli, clinica.nombre as nom_clinica, turno_atencion, especialidad, usuario.nombre_apellido as generado
                ...
                where registro.activo='1' and fecha_cita between '".$bus2." 00:00:00' and  '".$bus3." 23:59:59'";
