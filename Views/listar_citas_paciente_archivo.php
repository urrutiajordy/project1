...
<h3><div align="center"><span class="label label-info">HISTORIA PACIENTE</span></div></h3>
<br>
 <form method="post">
...
<td>
<span id="spryselect1">
<select id="dni_paciente" name="dni_paciente" class="form-control">
  <?php
		$query = $local -> query ("SELECT * FROM paciente where activo='1' order by nombre_apellido asc"); 
		echo '<option selected="selected" disabled="disabled" >--Seleccione--</option>';
		while ($valores = mysqli_fetch_array($query))
		{              
		echo '<option value="'.$valores['dni'].'">'.$valores['nombre_apellido'].'</option>';
		}
?>  
