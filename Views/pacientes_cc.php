...
<div align="left"><a href="central_citas.php"><img src="../imagenes/logo1.png" width="200px" /></a></div>
</div>
<!--Menú-->
...
<section> <table border="0" align="center">
	 <tr>
      <td width="500"><input  type="text" name="buscar" id="buscar" class="form-control" onkeyup = "lista_paciente(this.value,'1');" placeholder="BUSCAR PACIENTE POR: NOMBRE Y APELLIDO, DNI, HISTORIA, CONTRATO"/></td>
          ...
          <div class="modal-content">
			...
			<input class="form-control" type="hidden" readonly="readonly" id="pro" name="pro"/>
			    	<table border="0" width="100%" align="center">
					 ...
					 <tr>
					 <td>DIRECCIÓN</td>
					 <td><input class="form-control" type="text" autocomplete="off" onkeyup="mayus(this);"  name="direccion" id="direccion" placeholder="DIRECCIÓN"/></td>
					 </tr>
					 <tr>
					 <td>DISTRITO</td>
					 <td><input class="form-control" type="text" autocomplete="off" onkeyup="mayus(this);"  name="distrito" id="distrito" placeholder="DISTRITO"/></td>
					 </tr>
					 <tr>
					 <td>ESTADO CIVIL</td>
