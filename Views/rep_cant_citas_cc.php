...
$sql=$local->query("select count(id_registro) as cantidad
				from registro
				where activo='1' and fecha_cita between '".$bus2." 00:00:00' and  '".$bus3." 23:59:59'");
...
$sql=$local->query("select count(id_registro) as cantidad
				from registro
				where activo='1' and tipo_clinica='1' and fecha_cita between '".$bus2." 00:00:00' and  '".$bus3." 23:59:59'");
while($res=$sql->fetch_array()){			
?>		
				[<?php echo $res['cantidad'] ?>],
	<?php
...
$sql=$local->query("select count(id_registro) as cantidad
				from registro
				where activo='1' and tipo_clinica='2' and fecha_cita between '".$bus2." 00:00:00' and  '".$bus3." 23:59:59'");
while($res=$sql->fetch_array()){			
?>		
				[<?php echo $res['cantidad'] ?>],
	<?php
