...
<link href="../css/notifications_lib.css" rel="stylesheet" type="text/css"/>
...
<section> <table border="0" align="center">
	 <tr>
      <td width="500"><input  type="text" name="buscar" id="buscar" class="form-control" onkeyup = "listar_usuario(this.value,'1');" placeholder="BUSCAR USUARIO POR: NOMBRE Y APELLIDO"/></td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>DATOS USUARIO</b></h4>
            </div>
            <form name="formulario" id="formulario"  class="formulario" method="POST" action="../Controllers/CAdmin.php" enctype="multipart/form-data" >
			...
			<input class="form-control" type="hidden" readonly="readonly" id="pro" name="pro"/>
			    	<table border="0" width="100%" align="center">
					 ...
					 <tr>
					 <td>CLAVE</td>
					 <td><input class="form-control" type="password"   name="clave" id="clave"/></td>
					 </tr>
					 <tr>
					 ...
					 <tr>
					 <td>PERFIL</td>
					 <td><select class="form-control" name="id_perfil" id="id_perfil">
					 <?php
					 $perfil= $local->query("SELECT * FROM perfil ");
					 while($per= $perfil->fetch_array())
					 {
					echo '<option value="'.$per['id_perfil'].'">'.$per['nombre'].'</option>';
					 }
					 ?>
					 </select></td>
					 </tr>
            ...
            <div class="modal-footer">
            	<input type="submit" value="Registrar" name="Registrar_Usuario" class="btn btn-success" id="reg" />
                <input type="submit" value="Editar" name="Modificar_Usuario" class="btn btn-warning"  id="edi"/>
            </div>
            </form>
          </div>
        </div>
