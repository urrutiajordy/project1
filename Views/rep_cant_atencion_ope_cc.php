...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'CANTIDAD CITAS POR OPERADOR'
        },
        subtitle: {
            text: ''
        },
...
$bus3=$_POST["fechafin"];
$cli=$_POST["clinica"];
$sql=$local->query("select usuario.nombre_apellido as nom_cat, COUNT(registro.id_registro) as cantidad
				from registro
				inner join usuario on registro.operador=usuario.id_usuario
				where tipo_clinica='$cli' and fecha_cita between '".$bus2." 00:00:00' and  '".$bus3." 23:59:59' and registro.activo='1'
				group by registro.operador
				order by cantidad desc LIMIT 50");
...
<h2><div align="center"><h3><span class="label label-info">CANTIDA DE CITAS POR OPERADOR</span></h3></div></h2>
<br>
 <form method="post">
  <table align="center">
 <tr>
...
<input class="form-control" id="fechafin" name="fechafin" autocomplete="off" placeholder="MM/DD/YYY" type="text" value=<?php echo date('Y-m-d'); ?> /> <span class='input-group-addon'>
  ...
  <tr>
  <th><center><h4><span class="label label-info">CLINICA</span></h4></center></th>
  <td><div class="col-xs-12">
...
<div id='REPORTE_CANTIDAD_POR_OPERADOR' align='center'>
<!-------------------EXCEL EXPORTAR------------------------->
<table  border="0" class="toggle" style="font-size:12">
<thead>
<tr class='active'>
      <th><div align="center">N</div></th>
       <th><div align="center">NOMBRE OPERADOR</div></th>
	   <th><div align="center">ANIO OPERADOR</div></th>
...
if(isset($_POST["btn1"])){
	...
	$sql="select usuario.nombre_apellido as nom_ope, COUNT(registro.id_registro) as cantidad, tipo_clinica.nombre as nom_cli, ano_operador
				from registro
				inner join usuario on registro.operador=usuario.id_usuario
				inner join tipo_clinica on registro.tipo_clinica=tipo_clinica.id_tipo_clinica
				where tipo_clinica='$cli' and fecha_cita between '".$bus2." 00:00:00' and  '".$bus3." 23:59:59' and registro.activo='1'
				group by registro.operador
...
<script>
$('#REPORTE_CANTIDAD_POR_OPERADOR').tableExport();
</script>
