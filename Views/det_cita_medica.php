...
$local->select_db($database_local);
$query_DetailRS1 = sprintf("select id_registro, registro.dni as reg_dni, especialidad, fecha_cita, edad, paciente.nombre_apellido as nom_paciente,registro.monto as monto,	tipo_clinica.nombre as nombre_tip_cli, tipo_clinica, clinica.nombre as nom_clinica, turno_atencion, usu.nombre_apellido as nom_usuario, registro.id_servicio as id_ser,
							fecha_inicio, fecha_fin, operador,registro.n_clinica as num_cli, docente_clinica, ano_operador, diagnostico, papeleta_gen, paciente.his_clinica	 as h_clinica, paciente.contrato as contrato, registro.id_paciente as id_reg_pac, fecha_registro
							from registro
...
<tr>
<td>AÑO OPERADOR:</td>
<td><?php echo $row_DetailRS1['ano_operador'];?></td>
</tr>
<tr>
...
<tr>
<td>N. HISTORIA</td>
<td><?php echo $row_DetailRS1['h_clinica'];?></td>
</tr>
<tr>
<td>N. CONTRATO</td>
<td><?php echo $row_DetailRS1['contrato'];?></td>
</tr>
<tr>
